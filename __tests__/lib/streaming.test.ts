...
describe('sendThoughtDelta', () => {
  it('emits notifications/gemini-assistant/thought with correct shape', async () => {
  ...
  it('omits _meta when no progressToken', async () => {
    const notifications: unknown[] = [];
    const ctx = {
      mcpReq: {
        signal: { aborted: false },
  ...
  it('does not call notify when signal is aborted', async () => {
