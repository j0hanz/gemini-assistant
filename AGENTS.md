...
This document provides an overview of the architecture, tools, and development workflow for the MCP server that exposes Google Gemini as a multi-modal agent platform.
