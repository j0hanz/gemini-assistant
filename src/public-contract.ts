...
const TOOL_DISCOVERY_DETAILS = {
  ...
  analyze: {
    ...
    inputs: [
      'goal',
      'targetKind?',
      'filePath? (targetKind=file)',
      'urls? (targetKind=url)',
      'filePaths? (targetKind=multi)',
      'outputKind?',
      'diagramType? (outputKind=diagram)',
      'validateSyntax? (outputKind=diagram)',
      'thinkingLevel?',
      'thinkingBudget?',
      'maxOutputTokens?',
      'safetySettings?',
  ...
  review: {
    ...
    inputs: [
      'subjectKind?',
      'dryRun? (subjectKind=diff)',
      'language? (subjectKind=diff or failure)',
      'filePathA? (subjectKind=comparison)',
      'filePathB? (subjectKind=comparison)',
